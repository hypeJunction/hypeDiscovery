...
elgg_register_event_handler('init', 'system', function () {
    ...
    elgg_register_route('permalink', ['path' => '/permalink/{segments}', 'resource' => 'permalink', 'requirements' => ['segments' => '.+'], 'defaults' => ['segments' => '']]);
    elgg_register_route('opengraph', ['path' => '/opengraph/{segments}', 'resource' => 'opengraph', 'requirements' => ['segments' => '.+'], 'defaults' => ['segments' => '']]);
    ...
    elgg_register_plugin_hook_handler('entity:icon:url', 'all', [Icons::class, 'entityIconURL']);
    // BC
    ...
    elgg_register_menu_item('page', array('name' => 'discovery:settings', 'href' => 'admin/plugin_settings/hypeDiscovery', 'text' => elgg_echo('admin:discovery:settings'), 'context' => 'admin', 'section' => 'discovery'));
    elgg_register_menu_item('page', array('name' => 'discovery:site', 'href' => 'admin/discovery/site', 'text' => elgg_echo('admin:discovery:site'), 'context' => 'admin', 'section' => 'discovery'));
});